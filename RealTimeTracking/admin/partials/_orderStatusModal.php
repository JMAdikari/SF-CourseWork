...
include("config.php");
    ...
    while($itemModalRow = mysqli_fetch_assoc($itemModalResult)){
        ...
        $orderStatus = $itemModalRow['order_status'];
...
<!-- Modal -->
<div class="modal fade" id="orderStatus<?php echo $orderid; ?>" tabindex="-1" role="dialog" aria-labelledby="orderStatus<?php echo $orderid; ?>">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <?php 
            $deliveryDetailSql = "SELECT * FROM `rider` WHERE `orderid`= $orderid";
