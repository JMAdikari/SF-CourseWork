...
if(isset($_POST['update_product'])){
   ...
   $product_image = $_POST['product_image']; // Changed from file to link
...
<div class="admin-product-form-container centered">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" name="product_image" value="<?php echo $row['image']; ?>" placeholder="enter the image URL"> <!-- Changed to text input -->
